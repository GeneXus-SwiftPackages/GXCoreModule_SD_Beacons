...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.37.xcframework.zip",
			checksum: "e334484ec284928ed038cd30c1600875051726827fb3d1e7d38f53c12659892f"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.36.xcframework.zip",
			checksum: "806e16fa1ccfb4120d12330bfe2aecb5fb10a75eea23ebaec2f9161b4590b107"
		)
	]
)
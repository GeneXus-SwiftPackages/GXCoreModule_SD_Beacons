...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.0.0-beta.15.xcframework.zip",
			checksum: "7cfdd1c2b94b5220e082fad6ae3bc454bc5f5eb66ddcb7a9f63597019883314d"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.1.0-beta.26.xcframework.zip",
			checksum: "c2ac546dc0ae5b78e0d540685819e9b3285c5b1e9d6ea202364e7a0b3594c089"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.1.0-beta.25.xcframework.zip",
			checksum: "996d82256bd364b1628f8e4b19e78f09669607bddd9073cc63d301f77d0513cc"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.0.0-beta.44.xcframework.zip",
			checksum: "bfed963fd8aa7a5f8cfd0b2f69288feddee05e1bbabda475954e3364f79a3c3a"
		)
	]
)
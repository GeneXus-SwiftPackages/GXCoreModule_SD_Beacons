...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.0.0-beta.20230616185027.xcframework.zip",
			checksum: "70f5501dd0b260006213a418d23e48ad72d55e65aae96d02aeb5219f839dfaf7"
		)
	]
)
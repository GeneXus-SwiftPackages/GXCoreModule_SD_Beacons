...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-4.1.0-rc.14.xcframework.zip",
			checksum: "ea3ca1d671f7a67683065497966c80ed3b9812a37802d2e422df3f05943b9913"
		)
	]
)
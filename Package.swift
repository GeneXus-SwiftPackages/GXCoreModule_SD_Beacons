...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.1.0-beta.24.xcframework.zip",
			checksum: "65fca49f19cea99472f4385e3beec3cb93711206758cfddc12cc03e26d0d07ed"
		)
	]
)
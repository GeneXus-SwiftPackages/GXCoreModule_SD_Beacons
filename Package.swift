...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.39.xcframework.zip",
			checksum: "dbcee7dd69f377d2d6fc57df0843e04c65a36d367205a9f96520976d1fd7eada"
		)
	]
)
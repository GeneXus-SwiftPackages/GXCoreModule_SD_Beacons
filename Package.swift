...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.27.xcframework.zip",
			checksum: "2fa6741aa1c5d0b08257241cf56e2a2912593c25b7d7f9ff23aae02e87934514"
		)
	]
)
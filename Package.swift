...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.2.0-beta.14.xcframework.zip",
			checksum: "4689a287dffd1d5634165fc15638f03845f667de36f7fc13f02dbef5ed4992e0"
		)
	]
)
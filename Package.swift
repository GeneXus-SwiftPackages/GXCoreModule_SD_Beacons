...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-2.0.0-rc.32.xcframework.zip",
			checksum: "b63bff29f04eb1ea38d0f159fafe5a1297d5ce8b4f99ea3d97e71fb9506f837b"
		)
	]
)
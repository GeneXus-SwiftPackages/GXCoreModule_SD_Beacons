...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-3.1.4.xcframework.zip",
			checksum: "49e9f7e2ec83e7c6610985e8f7e3cde61191b69970b5b292a4bc5c022994878f"
		)
	]
)
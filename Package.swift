...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.1.0-beta.23.xcframework.zip",
			checksum: "5bde0ce5579c04e25e93e0b7ad13bc60dc6c2396136b9f186275791de2838612"
		)
	]
)
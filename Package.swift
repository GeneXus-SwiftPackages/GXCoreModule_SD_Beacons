...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.24.xcframework.zip",
			checksum: "d80ffe3ea19e30c0347b6c557a62185ee0f810924fa1426f9b7524d4583dba1f"
		)
	]
)
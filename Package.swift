...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.1.0-beta.9.xcframework.zip",
			checksum: "5d7d6bf2e16a904d876c8762959fadd1b3d72bfbffde0a6d2e1f0b3600501649"
		)
	]
)
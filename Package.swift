...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.7.xcframework.zip",
			checksum: "2c1501af108f21c25b424b3d0a49585ea57a00bce7bc9cc8d15b5aefc92a80e1"
		)
	]
)
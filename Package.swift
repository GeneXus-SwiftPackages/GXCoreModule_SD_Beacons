...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.23.xcframework.zip",
			checksum: "f25dabae7001ab4ee8af1316af467f42b0f2a5beed34bd5334ade21f98286b5d"
		)
	]
)
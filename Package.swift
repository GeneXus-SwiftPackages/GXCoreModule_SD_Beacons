...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-3.0.1.xcframework.zip",
			checksum: "d36deeaaddfb33e444c8d79d08a0b60014026bdfcf9f2196e2be0b798bc7e010"
		)
	]
)
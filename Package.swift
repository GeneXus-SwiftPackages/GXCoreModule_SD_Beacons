...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.19.xcframework.zip",
			checksum: "41bcecbb4594a96e3dc78d5cd8ba883ed425321047a8828a8b2db7f6a632d63c"
		)
	]
)
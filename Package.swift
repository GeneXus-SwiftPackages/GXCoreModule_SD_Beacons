...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.2.0-beta.14.xcframework.zip",
			checksum: "89bcc36bcf515062512600468078804821284ec0f0ecba86a76bee283327757d"
		)
	]
)
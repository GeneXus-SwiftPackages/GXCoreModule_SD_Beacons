...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.0.0-beta.49.xcframework.zip",
			checksum: "c5bb21036e2de61ddafc40708dc7ed6725187b91e8372dfd2a26ac79d3ea80f1"
		)
	]
)
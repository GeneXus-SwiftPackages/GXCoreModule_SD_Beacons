...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.5.17.xcframework.zip",
			checksum: "e3771fca7112887618f51ba6f3ff7274056809dc6a27754d0e8c82926269c127"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.1.0-beta.15.xcframework.zip",
			checksum: "f543cc42dc59956735ec354a854ed52f73f92d7ab01d92a489ff95ab99c8f019"
		)
	]
)
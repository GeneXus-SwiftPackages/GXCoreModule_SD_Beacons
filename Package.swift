...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-2.0.0-rc.36.xcframework.zip",
			checksum: "22de6639e7857e2afda425e77316f4a154323a4687a83e13a646456225c4b91d"
		)
	]
)
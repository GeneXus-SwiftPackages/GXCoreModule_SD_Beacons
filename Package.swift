...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.3.3.xcframework.zip",
			checksum: "d92ac03be1a0b253ae1504b9030b6b5de1f84765d16a33ea2d6b640998d30465"
		)
	]
)
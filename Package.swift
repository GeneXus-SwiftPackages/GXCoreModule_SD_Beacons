...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.4.0-rc.5.xcframework.zip",
			checksum: "0e4483d24fd60231b3b4c16ee44ca232fbb5cb2f96f35c8a937f47c7e40bd0db"
		)
	]
)
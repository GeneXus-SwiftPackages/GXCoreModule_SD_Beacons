...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.8.xcframework.zip",
			checksum: "afeabd1ecc9a8862a4becd30ff87bda2e8cdf1afc693fd13dacbf219691b15a3"
		)
	]
)
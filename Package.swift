...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.16.xcframework.zip",
			checksum: "91041da283eb300c97e6e65f9156ae0016a1937dbd6f9e3be2688383797898ea"
		)
	]
)
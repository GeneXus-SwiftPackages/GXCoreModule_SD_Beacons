...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.3.xcframework.zip",
			checksum: "85a0b2f41c9a3e1b3491c475e78510a5cfa47523761efd1e3d62031b80975f72"
		)
	]
)
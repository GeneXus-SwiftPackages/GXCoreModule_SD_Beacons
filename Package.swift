...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.25.xcframework.zip",
			checksum: "42c99daff78012a109567d18d8467668c0b9cc08fb65b873067339d1f08934e6"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.17.xcframework.zip",
			checksum: "42db510d23da2e28b9d7735e334cbe132f174766ff6cc21abd4141dd9b71eb67"
		)
	]
)
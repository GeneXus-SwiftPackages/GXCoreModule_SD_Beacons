...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.0.0-beta+20230217024255.xcframework.zip",
			checksum: "85290636bf48c12c9eb81947306f96f92ab3846428130856066868b5f2398875"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.1.0-beta.25.xcframework.zip",
			checksum: "106a0b4788e42853ccdc53187a80783080e04e71e76c7cf2cdb2bc027867b82b"
		)
	]
)
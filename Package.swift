...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.4.26.xcframework.zip",
			checksum: "5b004639c1f8149fdb664682d5ce371717e39fb72ac1ed6d1b8e1d0e95f3f7b2"
		)
	]
)
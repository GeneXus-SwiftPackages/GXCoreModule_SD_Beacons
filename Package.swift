...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-4.2.0-rc.34.xcframework.zip",
			checksum: "6ba55c91f2f25b4f47ea3d3faffff428985b23400e2f3b847bc7b17a4beb8082"
		)
	]
)
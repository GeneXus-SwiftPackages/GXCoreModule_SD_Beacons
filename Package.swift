...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.2.0.xcframework.zip",
			checksum: "814b769186ba22f8986351de28c7012bbdf2400a298b1c5d5bd01a073ce22985"
		)
	]
)
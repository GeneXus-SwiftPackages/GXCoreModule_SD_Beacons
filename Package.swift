...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.1.0-beta.6.xcframework.zip",
			checksum: "a7e1396dbd540f703db41e59d003a192fec4fbb0018bb0a17b4c37e82936f5b3"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.19.xcframework.zip",
			checksum: "168bf540b1fd678b1bb183bf1fb26f864142edf954dc0b45750ac468629969a2"
		)
	]
)
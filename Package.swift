...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-4.2.0-rc.20.xcframework.zip",
			checksum: "645a1ee8210ec2249570483d5a9f17e4d817c627d2e521aad0c17c8761ee29d3"
		)
	]
)
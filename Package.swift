...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.25.xcframework.zip",
			checksum: "ba077c38b9efed696f889befaf07a26482a37013b9eef64bfd90de5db679e48f"
		)
	]
)
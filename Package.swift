...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.1.0-beta.9.xcframework.zip",
			checksum: "887b03652676a56ca8cc549301c3d7d9a72f6d76d27a5bb55a783178977c1de2"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.0.0-beta.48.xcframework.zip",
			checksum: "b68f729c83b8decdb2b3ed4b5d537dd6cb715801305a14608b54eb83d2608856"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-3.2.0-rc.9.xcframework.zip",
			checksum: "f14652f7cdfc4477f294e9ab888e927a1c13f9923ca0a529ee4251db37ed0bc4"
		)
	]
)
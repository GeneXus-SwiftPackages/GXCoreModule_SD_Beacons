...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.1.0-beta.11.xcframework.zip",
			checksum: "ab0a5a188a8c484d2f0efffc0b43f7b0aa83f164289ce73e892af61a8c3ee8e9"
		)
	]
)
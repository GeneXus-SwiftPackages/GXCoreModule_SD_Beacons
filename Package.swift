...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.38.xcframework.zip",
			checksum: "3f1588a08671d9fcdaf1504cb9b12c5d2590325ca99b7e099ec3f521271fbbea"
		)
	]
)
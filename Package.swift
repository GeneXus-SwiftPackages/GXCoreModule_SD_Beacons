...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.40.xcframework.zip",
			checksum: "6f61516c30537e708dcbe79c5e35d49e388bbaa6900c3a4f8d50219ce1864a7d"
		)
	]
)
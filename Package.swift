...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.2.0-beta.20.xcframework.zip",
			checksum: "f0ab5de36efbd38d362c4e035ab258fad1fde57d6aa8a0865908bc8dcf656788"
		)
	]
)
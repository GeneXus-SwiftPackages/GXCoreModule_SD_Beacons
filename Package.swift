...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-2.1.4.xcframework.zip",
			checksum: "998983061089bd8c9c778ad6fd3efaeaefd8463122fd90f6be88b6967ff79ec4"
		)
	]
)
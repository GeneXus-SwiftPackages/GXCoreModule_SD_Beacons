...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.5.0-rc.26.xcframework.zip",
			checksum: "f84230f66ffde6c8d32fc44790634b74b99624022b54a35f67a052803807947c"
		)
	]
)
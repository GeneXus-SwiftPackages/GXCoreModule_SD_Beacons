...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.2.0-beta.19.xcframework.zip",
			checksum: "65212067fa3e43e786b00e8daf8f88c2fc25faa56f4aa16da2f3dc9acb375e70"
		)
	]
)
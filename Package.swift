...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-4.1.0-rc.22.xcframework.zip",
			checksum: "ab494774943ad6cff8f49670aa3e995b96b26d1b383065b118ef359ef6dbe31b"
		)
	]
)
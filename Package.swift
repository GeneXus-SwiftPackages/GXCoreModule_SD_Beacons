...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.5.0-rc.2.xcframework.zip",
			checksum: "b6b453fd838261fe8592da54d50245a486fda9acb42ce3ebabc6af07a7624e20"
		)
	]
)
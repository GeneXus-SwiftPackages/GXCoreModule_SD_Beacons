...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.4.xcframework.zip",
			checksum: "da8cdbc5fbd7b49a9e046560b625557a230a330a78759b3dba11601982f4fe64"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-4.1.0-rc.25.xcframework.zip",
			checksum: "255b2d117f98ef4c1449aff956c2f5000dce4e1ed1f0d35ae89daeea6822024e"
		)
	]
)
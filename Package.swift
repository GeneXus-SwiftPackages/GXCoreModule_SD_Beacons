...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.1.0-beta.22.xcframework.zip",
			checksum: "62a3ab536c9e8bf2c6460dd064811d27cd4dfa4f286cd18540eeae955278cef6"
		)
	]
)
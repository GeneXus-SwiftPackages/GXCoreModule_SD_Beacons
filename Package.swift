...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.2.0-beta.11.xcframework.zip",
			checksum: "cbf5a979fc79e042d4c731094130407731c8d39336993abc4bfeb91ec3b1ed44"
		)
	]
)
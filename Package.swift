...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.2.0-beta.7.xcframework.zip",
			checksum: "671c0106bc190f34b30d825ec89ced806ab9d57c079705e00ad93f3695f77ebb"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-4.0.16.xcframework.zip",
			checksum: "ebfa3e731a5682b75c063bf9be7cdb377c02a88e0a44625b9e5f4ff891e4bf07"
		)
	]
)
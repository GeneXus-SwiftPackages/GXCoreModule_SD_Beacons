...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.26.xcframework.zip",
			checksum: "de483206b2c6dc2a9257f1839ddf1fd00da335121ba8038b39b34acab131295f"
		)
	]
)
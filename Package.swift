...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-2.1.0-rc.25.xcframework.zip",
			checksum: "b906202e99b2e24a5417ee9b96bdb864797974a991abf95a1481dc60443f61bb"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-4.0.6.xcframework.zip",
			checksum: "c3465bd65daa5263a3ff70ddb508cc8ac14b1f14d588297f0ea459b0348ffac3"
		)
	]
)
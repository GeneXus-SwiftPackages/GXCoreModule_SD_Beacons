...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.3.0-beta.3.xcframework.zip",
			checksum: "e3e75e95a710e04850e3b32973cbbdb8892e2c1c8ce561eacfa00d2c20a94bad"
		)
	]
)
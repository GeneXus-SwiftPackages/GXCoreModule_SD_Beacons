...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-3.2.0-rc.13.xcframework.zip",
			checksum: "1b0802456173607a751f977d3bc8e2e18005d247b4d14201da3d0c9134f7a1fd"
		)
	]
)
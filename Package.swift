...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.0.0-beta+20230306155445.xcframework.zip",
			checksum: "75f3a8a9b2ebdd8364482ee2b22e6b8feba985d0fbdb40330c14e9c5b82abdb4"
		)
	]
)
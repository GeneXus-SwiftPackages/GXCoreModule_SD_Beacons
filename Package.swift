...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.0.0-preview.20230714192150.xcframework.zip",
			checksum: "5a59556932921503f92618046c40669e071ef3815af95765e30cab0622516fb9"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.1.0-beta.24.xcframework.zip",
			checksum: "fdcedcf0a6a89471529a8ea3f04f12b47504a1bc8c210990ec2872b48744cee5"
		)
	]
)
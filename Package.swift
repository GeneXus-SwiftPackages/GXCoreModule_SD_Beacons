...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.18.xcframework.zip",
			checksum: "4ad8b109e9924abf326be65a3247d87d75623e27ee1f07ff203f8f7779381c5c"
		)
	]
)
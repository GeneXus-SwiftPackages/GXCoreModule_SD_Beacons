...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.27.xcframework.zip",
			checksum: "854cbfa82d9c53033bbacbf06a095e2bb90a45a7f006533778a4859964d59b79"
		)
	]
)
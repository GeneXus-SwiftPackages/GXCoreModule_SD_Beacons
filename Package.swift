...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-2.1.0.xcframework.zip",
			checksum: "5b2127d2624cafb8dca7a147cab948583825ca61e79ce3a7e735ff7df90fe62d"
		)
	]
)
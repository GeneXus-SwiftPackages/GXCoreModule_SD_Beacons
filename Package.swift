...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.1.0-beta.13.xcframework.zip",
			checksum: "1011609155d22a5606e591cd302c184e553c490252a3ce49f220382cb5bfb242"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.3.5.xcframework.zip",
			checksum: "6544e9999fc45325b29d9077736f613853377059afc054cb5246a54ebeb59750"
		)
	]
)
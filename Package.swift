...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.2.0-beta.19.xcframework.zip",
			checksum: "dfd2584c7c2cb40c1111c66ebeb75eac676eadb6edf24ef0568a1bae421649e0"
		)
	]
)
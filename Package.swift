...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.19.xcframework.zip",
			checksum: "494eec3cd397c059350de2a7e76c85e51f69459ac8e5918326a57c312418b18f"
		)
	]
)
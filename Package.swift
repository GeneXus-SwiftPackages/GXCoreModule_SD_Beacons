...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.1.0-beta.3.xcframework.zip",
			checksum: "a12f6a802c82bb08fa3c49d3c100a8e7829461644d904e1d433673f5e85dc139"
		)
	]
)
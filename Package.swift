...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.7.xcframework.zip",
			checksum: "481f845ad63caa74baab7fe58c366df3e46b9f8bf861916b09f692b81bc60e88"
		)
	]
)
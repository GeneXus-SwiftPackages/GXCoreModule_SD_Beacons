...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.10.xcframework.zip",
			checksum: "1ee0e3faafb9b07c3767a6b592e95badda96abcc484bf7a0a23ade01239c9901"
		)
	]
)
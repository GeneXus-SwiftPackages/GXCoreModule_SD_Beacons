...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-2.0.0-rc.34.xcframework.zip",
			checksum: "8eb7817624b367ecbfb79b00c08b5a517ff7fa1c79ab1027204b01ac82d4b6c1"
		)
	]
)
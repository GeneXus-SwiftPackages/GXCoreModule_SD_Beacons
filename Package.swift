...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-4.0.8.xcframework.zip",
			checksum: "03f230bf0c50dbde39084df47b1f14781dfc651967625dac285e8b3fbf39522d"
		)
	]
)
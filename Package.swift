...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.1.0-beta.12.xcframework.zip",
			checksum: "89390aa32ec387cd63c1817ff129e995d1b15a6ff0ab700f1a79339aaf296718"
		)
	]
)
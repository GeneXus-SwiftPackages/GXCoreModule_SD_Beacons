...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.2.0-rc.15.xcframework.zip",
			checksum: "a3899dc2dc6cd79c5b56ba298c7ccc81d40b843e7f144685a661eee342f801fc"
		)
	]
)
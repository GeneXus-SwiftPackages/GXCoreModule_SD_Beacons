...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.28.xcframework.zip",
			checksum: "2f3e911d159f89e8124d847121fb43e426df57a2cd9ba1804930176c24546d89"
		)
	]
)
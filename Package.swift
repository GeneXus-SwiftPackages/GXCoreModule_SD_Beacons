...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.37.xcframework.zip",
			checksum: "69b08b7f3b2905ac55ccd18a4a3cd4e470d011255368b575cb823a9b6362b33f"
		)
	]
)
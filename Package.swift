...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.0.0-beta.20230617144628.xcframework.zip",
			checksum: "97de538187761e97d1949c758bffb4184b5bf52136a35bba5eaba9866c48bdd7"
		)
	]
)
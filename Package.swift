...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.9.xcframework.zip",
			checksum: "65458809237baec1ed4f7a96bc37fbe86e3438a36f6fc5589dfde9d88d61b4f4"
		)
	]
)
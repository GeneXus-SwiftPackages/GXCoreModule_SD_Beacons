...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.3.6.xcframework.zip",
			checksum: "91d966e8fd9e7901a47b1bdc6bad522eb0d976483c6129e76765239c72266d45"
		)
	]
)
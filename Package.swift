...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.13.xcframework.zip",
			checksum: "b3f05635bf5fd68bb57c822169cf5c6435b0bac9285b06f4ad3f1f640afa93db"
		)
	]
)
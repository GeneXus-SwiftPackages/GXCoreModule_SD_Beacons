...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.6.0-rc.0.xcframework.zip",
			checksum: "b1db39f7bc954baeb7714011b868be9da7e0d5c071c24d1da73b98502e9f826f"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.11.xcframework.zip",
			checksum: "eea5e8709583bb12806bddddb5e65ce55508f062746c0c286161ce06fbf1529d"
		)
	]
)
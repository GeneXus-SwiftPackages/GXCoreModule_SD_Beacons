...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.3.0-beta.1.xcframework.zip",
			checksum: "8d162cbd154fe98338783323d2dd9f712d070cd4ac2b1cae388a1bb8584ca060"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.34.xcframework.zip",
			checksum: "6fe3a62caa4806b2a2ea5352b33929e090c4f811f21fc107bceac475b8caccc8"
		)
	]
)
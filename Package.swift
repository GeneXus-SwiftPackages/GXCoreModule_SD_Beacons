...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.5.16.xcframework.zip",
			checksum: "2ae6f2702cb0352f2bddb8302fc81ba31e60fe910d9949af65417e2dcafa6083"
		)
	]
)
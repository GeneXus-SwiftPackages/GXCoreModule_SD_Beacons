...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-4.1.0-rc.24.xcframework.zip",
			checksum: "695f8f3881df0cee5e8b2c452c8bf427f81755e17762a5da37d1eb5e8c2ceda3"
		)
	]
)
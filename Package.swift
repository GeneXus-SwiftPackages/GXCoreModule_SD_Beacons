...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-3.0.0-rc.15.xcframework.zip",
			checksum: "9008df9e909c18cd3188a7306daf075f8747beecd82718199f8278a9ee4d80a2"
		)
	]
)
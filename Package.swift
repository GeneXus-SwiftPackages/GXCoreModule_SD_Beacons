...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.36.xcframework.zip",
			checksum: "750f315fd64354b590df71bc4524b42598eeaa84dc008d0ed6269e657a2b5634"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.20.xcframework.zip",
			checksum: "7ddefb563e2e0d1a7e21e938d9fa61a58bc198add431ff57dc3701ca2909e0a5"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.1.0-beta.11.xcframework.zip",
			checksum: "1fec17aa60b7b764764ae9e4ab9cff2572f5fb92f8368707c1254787cdd4ba30"
		)
	]
)
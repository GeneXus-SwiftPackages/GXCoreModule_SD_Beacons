...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-4.0.7.xcframework.zip",
			checksum: "89f37cab139ac04a8556422bf59ae3141523796ab03a3579b9b15e713796b2da"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.30.xcframework.zip",
			checksum: "41f40201eaa5b5f641c880204b97248b1bb92dde0b3e1aa054c850987fbe4828"
		)
	]
)
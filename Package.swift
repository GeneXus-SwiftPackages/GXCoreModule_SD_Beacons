...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-3.0.3.xcframework.zip",
			checksum: "9d75746ea8e2c45aef41f1b47b4272c794e965a611208b296f8702e2a4167d48"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.30.xcframework.zip",
			checksum: "205e00c0cd18688475abe289e3f1d4215b57ff323c648605dd3984e18e3025dc"
		)
	]
)
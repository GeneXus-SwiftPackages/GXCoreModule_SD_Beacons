...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.12.xcframework.zip",
			checksum: "5f681c6ed127dd55ab3ba54627d0ffdba60a5f38a71d6723a8d1e7227ba6da68"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.3.0-beta.4.xcframework.zip",
			checksum: "fa030044f90993a8b8263b72d0b314d03580c8c8f009034e7b3a631905f9e9f9"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.29.xcframework.zip",
			checksum: "2003c5f752f9048cdfb736b602a551e447f7e27c0cc85ce61eb6e4c48b0441b4"
		)
	]
)
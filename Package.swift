...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.26.xcframework.zip",
			checksum: "9244cce1d544bc86c4acc9e1ccda0fe86bfbbe6037194b0f663f8899afed5ced"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.2.xcframework.zip",
			checksum: "fdf0426f4a7a666d61cf598817185d7a3b7ea359a144c0ddfc7935cd53500376"
		)
	]
)
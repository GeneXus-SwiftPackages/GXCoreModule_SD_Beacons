...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.8.xcframework.zip",
			checksum: "b869010efd9b1a665a4a5e35e410a44e0d005ba89e625d0cd1f2df5cd7a2ea8f"
		)
	]
)
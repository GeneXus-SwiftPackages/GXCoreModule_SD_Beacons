...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.12.xcframework.zip",
			checksum: "280d99685c0e899bb557139df47fdf929bf2d094591e2e59aed5788792905780"
		)
	]
)
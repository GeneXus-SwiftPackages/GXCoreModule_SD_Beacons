...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.0.0-beta.20230717172207.xcframework.zip",
			checksum: "9c9f0b882db3b505d70650a98777e3fce79ecd96b662af0cdb49a3ead731ded4"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-5.0.0-beta.1.xcframework.zip",
			checksum: "1685ed47e40db88f79b37740077877d8726ff501db702f26e6310e4bec9edeac"
		)
	]
)
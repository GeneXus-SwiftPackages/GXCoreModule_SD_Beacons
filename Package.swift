...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.13.xcframework.zip",
			checksum: "2b6f583a84a9002bf8c96a5d085542579d6b0cbcc317b380cafe617c8138c276"
		)
	]
)
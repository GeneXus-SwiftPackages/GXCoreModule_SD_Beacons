...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.18.xcframework.zip",
			checksum: "d5c1f06c448ac0f51c7a2fba61b13f9248a0a9b0c96211fd9958d82f8c0d1177"
		)
	]
)
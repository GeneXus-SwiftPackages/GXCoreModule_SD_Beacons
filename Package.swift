...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.21.xcframework.zip",
			checksum: "45d2f43a3c614fb9f460e9775c42800d4b003a5380ee5dab701336fda9a0f620"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.36.xcframework.zip",
			checksum: "00d2b5b55f17adcd539e5c5585aafabb99da60e6e8953cadc6d87e4b67a39415"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.6.xcframework.zip",
			checksum: "7175c90f078eb5b7f8595cd3c9cd6c51c64a11cd32deeef326915129b640b625"
		)
	]
)
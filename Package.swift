...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.0.0-beta.20230717155910.xcframework.zip",
			checksum: "6bd39656580bc24b3c093dad48608d46c0aced976be87ebca01fc2a2b5a14165"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.28.xcframework.zip",
			checksum: "ae86a6ca446d795ee87e2f705de6c69c3249d6d60e1c5168cca7200be4c97522"
		)
	]
)
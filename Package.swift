...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.1.0-beta.7.xcframework.zip",
			checksum: "a0983353ef8516d136161d70bfa512b32b034de79f1791ba7330049927901943"
		)
	]
)
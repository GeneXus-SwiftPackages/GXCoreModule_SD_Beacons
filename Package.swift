...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-3.1.0-rc.3.xcframework.zip",
			checksum: "f4cee1891dda690be4fddcfc08d6d8d1f4d86aa9fd018d14038787e4907cd60b"
		)
	]
)
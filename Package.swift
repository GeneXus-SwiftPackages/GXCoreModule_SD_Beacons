...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.2.0-beta.10.xcframework.zip",
			checksum: "3faf59dafac549fbec720bbdd89458c0c882e1d90d9d5d969dfc09e23160b7ed"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-3.2.0-rc.11.xcframework.zip",
			checksum: "84da866a2377722f6dcd1cc6b1ee3a8715cdd2333b4df25570e0bb6447633b0c"
		)
	]
)
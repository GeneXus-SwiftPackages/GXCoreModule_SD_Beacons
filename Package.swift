...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.9.xcframework.zip",
			checksum: "f0a43aa6e15fd8e317dff943671ef569b6cd11b626c588b17e0bbd4624f35774"
		)
	]
)
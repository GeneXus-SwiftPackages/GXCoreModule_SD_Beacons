...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.21.xcframework.zip",
			checksum: "38f3b78807f70330bcdd1a996c6bd615bd6c62413dd1393a0ad05467b7ef8290"
		)
	]
)
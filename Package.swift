...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-5.0.0-rc.1.xcframework.zip",
			checksum: "c8a541680d7e0981b22a21b58d2c69e412c02900859fcedf9404311960727d51"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.41.xcframework.zip",
			checksum: "51f19c5ce0d2a967d92eff93f09aaef012f6e5179319901c2a3af832cfa2dc12"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-4.0.17.xcframework.zip",
			checksum: "547349a33291d9c34c9719c91c3f22703fd2285c05a042746b554937100da0b2"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.3.0-beta.10.xcframework.zip",
			checksum: "4a5b3590ca861bc88571ee03a96c239991b34b53af50414f2c9293f618a20ad3"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.3.xcframework.zip",
			checksum: "e9337094292b15a5a03742834bd77f04b2ef8609deae0d68ca4a87dfc5f10b8b"
		)
	]
)
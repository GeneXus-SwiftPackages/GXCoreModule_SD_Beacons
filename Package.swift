...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.2.0-beta.12.xcframework.zip",
			checksum: "76eb5aafd3c6cf01b72fc739c150548186cb8b7e72a3f2de869e64ca2f6502af"
		)
	]
)
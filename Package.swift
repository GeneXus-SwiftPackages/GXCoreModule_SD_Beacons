...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.6.xcframework.zip",
			checksum: "bd6f56040d70142a3a29850fde462d48f640c1949aadf1b9424266735754bf20"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.3.0-rc.1.xcframework.zip",
			checksum: "78a32589ac1c6862cacb265efdcb9ae1ba698803dfda7f31af2acb19fd0c1fc3"
		)
	]
)
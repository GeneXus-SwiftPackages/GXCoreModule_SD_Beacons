...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-5.0.0-rc.0.xcframework.zip",
			checksum: "15bb0cfbedcd6280f3ac8254e1a1d0ef8ad50834c21af4c3b94af5ab89e4e4f5"
		)
	]
)
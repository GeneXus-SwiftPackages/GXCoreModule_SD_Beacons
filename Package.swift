...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.2.xcframework.zip",
			checksum: "4f212a7cd111bc826a2b7a003051e49add5c744720d3fd5282dcc37b11b151b9"
		)
	]
)
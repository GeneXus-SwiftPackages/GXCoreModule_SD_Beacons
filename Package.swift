...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.37.xcframework.zip",
			checksum: "bbe6f1c3949ef833c0422a276a8ffc03f7b314b1854ba7d2e24b2585437bfbb8"
		)
	]
)
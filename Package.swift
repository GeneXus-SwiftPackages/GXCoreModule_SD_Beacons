...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.40.xcframework.zip",
			checksum: "6b535a80b6632323bfb4414df24c4849adba8b2d7eaa5c77e9dcae29a4418702"
		)
	]
)
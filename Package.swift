...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.5.xcframework.zip",
			checksum: "8fc0f5a4c7d1042e5ba8bb9cee0690d6648ab715c11517e86f0c609efd1501b3"
		)
	]
)
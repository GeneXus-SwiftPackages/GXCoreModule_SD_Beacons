...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.3.0-beta.11.xcframework.zip",
			checksum: "45d3d1809554453c439b9702c7bb595d7ed88fe9e07de2c0bbc5a10cfdaf397d"
		)
	]
)
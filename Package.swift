...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-2.0.0-rc.22.xcframework.zip",
			checksum: "8cc74ba2965799e7637ab26cde45061ee01a06117eef8dcc3b8de42b4511a0a0"
		)
	]
)
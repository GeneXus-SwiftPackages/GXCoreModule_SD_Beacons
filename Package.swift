...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.22.xcframework.zip",
			checksum: "9e0ee910f4097ac517f8122fbae645d1b01fc69a84534c07458e44b5cdea5aa9"
		)
	]
)
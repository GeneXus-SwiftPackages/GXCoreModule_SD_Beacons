...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.2.0-beta.33.xcframework.zip",
			checksum: "41c1417187968f35f0a7378dec575ebb0b716aa31531e4eda4f0b2cbb4d30574"
		)
	]
)
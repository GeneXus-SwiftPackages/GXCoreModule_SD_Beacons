...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.1.0-beta.9.xcframework.zip",
			checksum: "a98dcdb78c87b184b466159a4b2cc72169369bcb151780f2e66a92cdb27bf122"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.10.xcframework.zip",
			checksum: "9900ec1a0b17e12d8675363213b6d6298e4946b573bd72f671bb390c30d9fe31"
		)
	]
)
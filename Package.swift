...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.3.0-beta.8.xcframework.zip",
			checksum: "16daa9173fc3417135c4db43286bde72984f2cc1d34ef7568e450b702b8a3b3c"
		)
	]
)
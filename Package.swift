...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.4.0-rc.21.xcframework.zip",
			checksum: "42d918167a7a06de0a1b68ddb4761729d1e84f691127fc309ceb5a36626f3783"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.7.xcframework.zip",
			checksum: "9d6c00a224d5ce5117e5cdb2ade820c57f1ef169bbbd46ffe3b19908b68e0748"
		)
	]
)
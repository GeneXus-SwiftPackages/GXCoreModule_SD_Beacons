...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-4.2.0-rc.3.xcframework.zip",
			checksum: "dd29ee19818c53e0b85191663a700a141ecd906b26b9d5beeadbece736e94a28"
		)
	]
)
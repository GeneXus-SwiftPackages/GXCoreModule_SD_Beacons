...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.16.xcframework.zip",
			checksum: "358592ace20edc2c2065c267e185d38fbcd2f18de7db4c097f8e295a737196d9"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.4.31.xcframework.zip",
			checksum: "1264e2c898dd341dad0834d280e3050adb804aaf759fd30ce6bdd00cb7fe5649"
		)
	]
)
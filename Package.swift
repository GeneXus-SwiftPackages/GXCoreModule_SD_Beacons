...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.2.1.xcframework.zip",
			checksum: "090d4abc60a42390142bb32d165baea328a88e9f135e9f99dba505d7d9b58836"
		)
	]
)
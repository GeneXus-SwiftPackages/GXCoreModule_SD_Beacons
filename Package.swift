...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.5.0-rc.28.xcframework.zip",
			checksum: "a6b9689843f77f3bab16f9e9646957a049395fdf1bf2c6e14a51b6fbe9c52e4f"
		)
	]
)
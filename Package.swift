...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.0.0-beta.20230630183632.xcframework.zip",
			checksum: "b12401fe78a58e5d66769a74c3aa17d0c36f90716b6de056b43836c6bcd8e2ef"
		)
	]
)
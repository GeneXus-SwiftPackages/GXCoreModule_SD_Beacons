...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.6.0-beta.3.xcframework.zip",
			checksum: "4ec41d0364fe4de2f5b2466f3b406780b1a591252d4dbff67069d2eba0fdb921"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-3.0.4.xcframework.zip",
			checksum: "a6b39cd0f6fa7210ed668bba3f93f7c60ebfacef74b282e95f739eac4af58770"
		)
	]
)
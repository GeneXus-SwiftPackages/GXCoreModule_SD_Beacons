...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.1.0-beta.4.xcframework.zip",
			checksum: "da99effd27dffd3b05b154d05845519fa03c75433bf571af4610146e4c5125ef"
		)
	]
)
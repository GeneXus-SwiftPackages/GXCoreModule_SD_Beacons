...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-3.0.0-rc.2.xcframework.zip",
			checksum: "0f4b241bbe487fff754133c7e061151f913460221d5adde4949b43ae3c8758d8"
		)
	]
)
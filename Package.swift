...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.22.xcframework.zip",
			checksum: "1690a23e0e5fff97249f9f8f3be248edd02cc659eb3d3a8e491402dbe160b2f6"
		)
	]
)
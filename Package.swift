...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.25.xcframework.zip",
			checksum: "d5bb752711f4957017b1de184028f0c8c059cb7e0adf404bc70c75d1103439b1"
		)
	]
)
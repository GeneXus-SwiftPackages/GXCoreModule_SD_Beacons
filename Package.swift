...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-1.4.0-rc.1.xcframework.zip",
			checksum: "da18fbf53f2a3c3ed07c349403a53539415da7c2b39c531d52debe4193f496b1"
		)
	]
)
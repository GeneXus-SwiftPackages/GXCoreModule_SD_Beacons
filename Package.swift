...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.4.0-beta.14.xcframework.zip",
			checksum: "4d7b8ffc5f2cd04e5a282859ff588d8ac37200df8baa7b4ff36e84ea187197c9"
		)
	]
)
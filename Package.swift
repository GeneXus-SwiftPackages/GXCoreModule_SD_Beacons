...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-4.1.1.xcframework.zip",
			checksum: "12dcf48a2c42e37874f4813828dd5edc2d9fdaf6434d05efb6063c283937ce81"
		)
	]
)
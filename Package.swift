...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.31.xcframework.zip",
			checksum: "5e45a055e61d633a52e1a3556b50c9364e3c3d041bfd265004b3426cbdde57ec"
		)
	]
)
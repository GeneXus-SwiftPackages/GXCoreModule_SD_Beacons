...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.1.0-beta.6.xcframework.zip",
			checksum: "f85324bf148193c86dde4f04ecc8993a20f965d03c2db9fb1bdfc7c82b93964d"
		)
	]
)
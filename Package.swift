...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-4.1.5.xcframework.zip",
			checksum: "198638f75d201cd6c499922ad4ab3b38880585decb09414c6953553d4ca2fd00"
		)
	]
)
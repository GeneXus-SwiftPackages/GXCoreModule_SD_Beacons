...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.2.0-beta.8.xcframework.zip",
			checksum: "ef4c73966be52b95fc9a728269ebc8fa0502380453c07e5d90fc2c7c109ff3b9"
		)
	]
)
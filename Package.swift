...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.0.0-beta.17.xcframework.zip",
			checksum: "04aff54c721ddb9b9243b0a48312e1015b8df01b7eb0731172d8d3d267a2054c"
		)
	]
)
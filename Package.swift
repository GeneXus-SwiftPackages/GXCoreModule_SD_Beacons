...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.2.0-beta.38.xcframework.zip",
			checksum: "8e38b9615ac69bf402f66a8a9e93637e020bdee5e7a9e2a671d779a1c7cbd1d4"
		)
	]
)
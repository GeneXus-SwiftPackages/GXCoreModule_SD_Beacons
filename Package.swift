...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-4.0.0-rc.0.xcframework.zip",
			checksum: "e527b4746d8522edd924a653cb98c4ebc356e9abf3ecbc908066f6633c9aa295"
		)
	]
)
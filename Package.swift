...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.0.0-beta.11.xcframework.zip",
			checksum: "3536aa2aedb9784cfccd4a665630f5b42e61f1da03d037b3a9463c5f44a0afd0"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.1.0-beta.5.xcframework.zip",
			checksum: "c7ac6965fa9e7f311ba7b4abcb8a6553f82d8134b0347251dbb5cedfb7c55d92"
		)
	]
)
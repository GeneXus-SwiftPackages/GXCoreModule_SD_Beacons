...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.0.0-beta.12.xcframework.zip",
			checksum: "1b64a193303e4e44f439693c7480a94995347aa2bc844055cac1150e9f11452a"
		)
	]
)
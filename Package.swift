...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-4.1.0.xcframework.zip",
			checksum: "216acfa97200fb62ca3160ac6ffb4e707ebce1ee20116a3c1e848ca01202e5cf"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.27.xcframework.zip",
			checksum: "97090d157ebb0f294ee783d69b96299528603c24681f2fa033990ebae47629e9"
		)
	]
)
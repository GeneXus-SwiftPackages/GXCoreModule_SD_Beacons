...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-4.1.2.xcframework.zip",
			checksum: "3340609de435e9da11983bf43f40a651389794451b28c3f86160c4ae1cc70b20"
		)
	]
)
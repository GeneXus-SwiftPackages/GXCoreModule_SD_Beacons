...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.2.0-beta.24.xcframework.zip",
			checksum: "b9e3370cd25b3e40e80e0e49585df31390c721076fc602004c75d72afce70aa8"
		)
	]
)
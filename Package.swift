...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.32.xcframework.zip",
			checksum: "b4a983fa8ca66c4e9cc0820a2e6c78a541b3d0426eddbf9f5a4517f101e9601e"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.2.0-beta.12.xcframework.zip",
			checksum: "64918a32a60c71110805ae7920d1380b7c64d80b6af31caaebc94df16e1f1bed"
		)
	]
)
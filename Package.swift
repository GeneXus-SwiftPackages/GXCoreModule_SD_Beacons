...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-2.1.0-rc.23.xcframework.zip",
			checksum: "73d04b37c78188d8100cfc84f88815ccbfa151120f733899dc4bdd75139d92dc"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.0.0-beta.45.xcframework.zip",
			checksum: "cbc54119c13b7ad73ebb0c44a0b0fa2231c165994c8f4fc6dcea44c5f6bac546"
		)
	]
)
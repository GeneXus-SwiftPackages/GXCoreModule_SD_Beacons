...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-1.3.0.xcframework.zip",
			checksum: "4412400fd4f44f1b19ccf6a2e6bf017ff71f88f18ee84884bf90ce3fb4f95886"
		)
	]
)
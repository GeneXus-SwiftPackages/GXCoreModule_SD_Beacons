...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-3.2.0-rc.12.xcframework.zip",
			checksum: "5ee5240716e63a924ce12508226a43479a50a7b64141f08196cd6077d106499f"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-3.0.2.xcframework.zip",
			checksum: "cbf1bca91071975dfa00f798197192804fba9f2943997639ef69fcc8e7e8dc93"
		)
	]
)
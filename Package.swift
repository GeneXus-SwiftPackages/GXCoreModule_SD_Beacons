...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.2.0-beta.1.xcframework.zip",
			checksum: "6f44eb1ae293bc2ad42cab5d0edaf3b7276036b5ee12e0841864aa9895a5270a"
		)
	]
)
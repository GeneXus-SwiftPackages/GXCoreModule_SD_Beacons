...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.29.xcframework.zip",
			checksum: "b7745183ace317cc9ea71fb3680299a4decca8a6939b8668d31bc9bb9c30f113"
		)
	]
)
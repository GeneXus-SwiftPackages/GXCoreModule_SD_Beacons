...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Beacons-3.2.0.xcframework.zip",
			checksum: "f2862297ac5889eeaacc81ad2814848cab748981b05ef6c5d106309a1d5b8c63"
		)
	]
)
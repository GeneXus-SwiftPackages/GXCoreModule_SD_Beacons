...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.1.0-beta.12.xcframework.zip",
			checksum: "79f9b1cca20025227bebf4db729b962fa8fea3ae1ecce0c8b9a07840bfe6318e"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-3.1.0-rc.8.xcframework.zip",
			checksum: "829b5df674dee0ff59d13d6f55d91e1d70ebb7626f49ce40936462ad105c22f0"
		)
	]
)
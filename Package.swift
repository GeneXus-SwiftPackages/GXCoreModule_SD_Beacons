...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Beacons-4.0.0-rc.43.xcframework.zip",
			checksum: "953a0d7a6bcf71d4fa382880f8889ba8b32e044c4230c9aa9adfd1dfeee6a672"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.23.xcframework.zip",
			checksum: "bfc45028776f9d028f38a865366f5f0d4c8a56e72209f8752924f4f6c720c3c8"
		)
	]
)
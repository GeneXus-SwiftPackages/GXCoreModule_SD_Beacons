...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-5.0.0-beta.4.xcframework.zip",
			checksum: "410085f9afec1c9707e616d6e657c148c02b085c093205269e637117d6af5172"
		)
	]
)
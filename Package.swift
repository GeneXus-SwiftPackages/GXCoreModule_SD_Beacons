...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-3.1.0-beta.5.xcframework.zip",
			checksum: "63bf65da96d5737b679d6c48c90e8b3df854333229d48027d16480350a34fdae"
		)
	]
)
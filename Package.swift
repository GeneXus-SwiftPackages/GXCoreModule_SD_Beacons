...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.0.0-beta.47.xcframework.zip",
			checksum: "02bd94d8622a8733323bbfaa4ab2066fe2be55e64942f67ee7b96d310e2d6e36"
		)
	]
)
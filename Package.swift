...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.35.xcframework.zip",
			checksum: "9a7d9f23bfb3ee6a5ea7dc947ca9eb4fc0a4bc971c89684e991b43238e5b04d0"
		)
	]
)
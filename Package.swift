...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.17.xcframework.zip",
			checksum: "af71ba1b339e05589065a3360557a1c0fde3ee542bc384e44fa1a0d25031c6c1"
		)
	]
)
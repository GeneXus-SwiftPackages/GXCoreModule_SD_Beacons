...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.6.0-beta.4.xcframework.zip",
			checksum: "ca5db1b5461bd1ee8ddd666bd48f75498c5f2b45daac0cbb968e31bc4b530a3f"
		)
	]
)
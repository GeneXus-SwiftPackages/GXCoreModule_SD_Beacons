...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.1.0-beta.23.xcframework.zip",
			checksum: "41650f387b5a5794056b3469320b16c29778488d0c6cb3331d3ac36e0cdb365e"
		)
	]
)
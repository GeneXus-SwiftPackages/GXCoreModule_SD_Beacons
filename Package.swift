...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-4.2.0-beta.31.xcframework.zip",
			checksum: "1b822a1f92b93938e738ce99a93e4eb7db075ecd7facc64c4e24bb9a01aa81d4"
		)
	]
)
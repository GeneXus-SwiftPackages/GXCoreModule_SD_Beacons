...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.20.xcframework.zip",
			checksum: "a815117564667cb9bcd623f2e34b6f16719cae03f0b22e9e65661844690486a1"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-2.0.0-beta.31.xcframework.zip",
			checksum: "17ebb0b8bf5e63adcc17d7e9e5318023d60d81f497023c3c7d3b0a815fe1e466"
		)
	]
)
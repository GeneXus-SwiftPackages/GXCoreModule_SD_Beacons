...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.5.0-beta.24.xcframework.zip",
			checksum: "e677e927e1ef65672f78e91cfa95efff37c25416cd2f1f4bf106ae0c24271440"
		)
	]
)
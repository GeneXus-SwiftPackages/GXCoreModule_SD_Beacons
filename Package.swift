...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Beacons",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Beacons-1.2.0-beta.19.xcframework.zip",
			checksum: "c70bf506a2789135ed3b3cdeba740f73d5967356d69027ad6ea9c90c3a7a429f"
		)
	]
)